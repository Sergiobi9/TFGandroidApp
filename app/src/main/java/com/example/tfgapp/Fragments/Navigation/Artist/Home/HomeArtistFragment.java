            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                switch (response.code()) {
                    case 200:
                        ...
                        Bundle bundle = new Bundle();
                        HomeArtistFragment homeArtistFragment = new HomeArtistFragment();
                        homeArtistFragment.setArguments(bundle);
                        getFragmentManager().beginTransaction().replace(R.id.main_fragment, homeArtistFragment).addToBackStack(null).commit();
                        dialog.dismiss();
                        break;
                    default:
